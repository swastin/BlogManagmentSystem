...
<body class="login-page" style="background-image: url('images/p1.png');">
    <div class="login-box">
        ...
        <div class="card z-depth-5" style="opacity:0.9;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.6), 0 6px 20px 0 rgba(0, 0, 0, 0.19)" >
            <div class="body">
                <form id="sign_in" method="POST">
                    <div class="msg  m-b--20">Sign in to start your session</div>
